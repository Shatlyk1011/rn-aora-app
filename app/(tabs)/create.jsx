    ...
    <SafeAreaView className="bg-primary h-full ">
      <ScrollView className="px-4 my-6">
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker("video")}>
            {form.video ? (
              ...
              <View className="w-full h-32 px-4 bg-black-100 rounded-2xl justify-center items-center">
        ...
        <FormField
          title="AI prompt"
          value={form.prompt}
          placeholder="The prompt you used to craete this video"
